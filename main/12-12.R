...
zparam = list(beta= c(0.4,0.5,-0.2,0.3), sigma_z=1, include_interaction=FALSE)
...
res6_test2<-main_simu2_parallel(nco=9,N=1000,nt=nt,ns=ns,betat=betat,betas=betas,xi=c(0,0,0),
                                zparameter = zparam)
t2=Sys.time()
t2-t1
reslist[[1]]=res6_test2
gc()
...
res6_test2<-main_simu2_parallel(nco=9,N=1000,nt=nt,ns=ns,betat=betat,betas=betas,xi=c(0.5,-0.5,0.3),
                                zparameter = zparam)
t2=Sys.time()
t2-t1
reslist[[2]]=res6_test2
gc()
...
for(i in 3:length(rho_list_diffz) ){
  ...
  t2=Sys.time()
  cat("\n",t2-t1)
  reslist[[i]]=res6_test2
  gc()
}

save(reslist,rho_list_diffz,zparam,evalua,betat,auc_true_est,file="summary_12_12_navie_ci_ns500.rdata")
...
save(reslist,rho_list_diffz,zparam,evalua,betat,auc_true_est,file="summary_12_12_navie_ci_ns1k.rdata")
...
save(reslist,rho_list_diffz,zparam,evalua,betat,auc_true_est,file="summary_12_12_navie_ci_ns1_5k.rdata")
...
res6_test2<-main_simu2_parallel(nco=ncor,N=1000,nt=nt,ns=ns,betat=betat,betas=betas,xi=c(0,0,0),
                                zparameter = zparam)
t2=Sys.time()
t2-t1
reslist[[1]]=res6_test2
...
res6_test2<-main_simu2_parallel(nco=ncor,N=1000,nt=nt,ns=ns,betat=betat,betas=betas,xi=c(0.5,-0.5,0.3),
                                zparameter = zparam)
t2=Sys.time()
t2-t1
reslist[[2]]=res6_test2
...
save(reslist,rho_list_diffz,zparam,evalua,betat,auc_true_est,file="summary_12_12_navie_ci_ns2k.rdata")
